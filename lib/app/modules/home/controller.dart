...
class HomeController extends GetxController {
  ...
  void changChipIndex(int value) {
    chipIndex.value = value;
  }

  void changTask(Task? select) {
    task.value = select;
  }
  ...
  void changDeleting(bool value) {
    deletting.value = value;
  }
